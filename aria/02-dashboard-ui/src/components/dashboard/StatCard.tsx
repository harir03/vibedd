...
const TOOLTIP_TEXTS: Record<string, string> = {
    "Requests": "Total number of HTTP requests processed by ARIA in the selected period.",
    ...
    "4xx Blocked": "Total number of 4xx responses triggered by ARIA blocking actions.",

...
export function AddApplicationModal({ isOpen, onClose, initialData }: AddApplicationModalProps) {
    ...
    useEffect(() => {
        if (isOpen && initialData) {
            ...
            if (initialData.blockchainConfig) {
                ...
                setPrivateKey(initialData.blockchainConfig.privateKey || ""); // Note: Sending PK back to client is risky but assuming internal tool usage
    ...
    const handleSubmit = async () => {
        ...
        try {
            // No-op: API removed
            console.log("Application submit (no API):", {
                name: appName,
                domain,
                ports,
                type: activeTab,
                            ...
                            <div className="pl-7 space-y-3 animate-in fade-in slide-in-from-top-2 duration-200">
                                <div className="space-y-1">
                                    ...
                                    <input
                                        ...
                                        placeholder="0x..."
                                        className="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm font-medium focus:outline-none focus:border-indigo-500"
                                    />
                                </div>
                                <div className="space-y-1">
